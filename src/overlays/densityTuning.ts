...
export const DENSITY_TUNING_BOUNDS: Readonly<Record<keyof DensityTuning, TuningBound>> = {
...
export function clampDensityTuning(tuning: DensityTuning): DensityTuning {
  return {
    ...
    gamma: clampTo(DENSITY_TUNING_BOUNDS.gamma, tuning.gamma, DEFAULT_DENSITY_TUNING.gamma),
  };
}
