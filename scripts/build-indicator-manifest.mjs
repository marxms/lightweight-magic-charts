 ...
 * See scripts/indicator-proof/value-ledger.mjs for what it closes and what it does not.       */
{
  ...
  const faults = valueLedgerFaults({ committed, derived: fingerprints, ledger: VALUE_CHANGES, offered, encoding, underCommitted, vendor, renames: RENAMES.renames ?? [], withdrawn: WITHDRAWALS.withdrawals ?? [] });
  if (faults.length > 0) {
